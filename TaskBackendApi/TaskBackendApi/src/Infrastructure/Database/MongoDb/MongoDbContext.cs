...
public class MongoDbContext : Application.Abstractions.Data.IMongoDbContext
{
    ...
    {
        return Database.GetCollection<T>(name ?? typeof(T).Name.ToLower(System.Globalization.CultureInfo.CurrentCulture));
    }
